...
export default class PlayerProfile extends Component {
	...
	saveToList = () => {
		if (localStorage.jwt === undefined) {
			this.setState({
				alertTitle: "Error",
				alertBody: "You must log in to use this functionality.",
				alertShow: true
			});
		} else {
							...
							<Table>
								...
								<TableBody>
									<TableRow>
										...
										<TableCell align="right">
											{this.state.fantasy.fantasyValue}
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell component="th" scope="row">
										...
										<TableCell align="right">
											{this.state.stats.lsGamesPlayed}
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell component="th" scope="row">
										...
										<TableCell align="right">
											{this.state.stats.lsMinutesPerGame}
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell component="th" scope="row">
										...
										<TableCell align="right">
											{this.state.stats.lsPointsPerGame}
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell component="th" scope="row">
