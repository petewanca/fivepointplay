				...
				response.forEach((item) => {
					player = {
						...
						lsFieldGoalPercentage:
							item.dataValues.lsFieldGoalPercentage,
						lsThreePointPercentage:
							item.dataValues.lsThreePointPercentage,
						lsFreeThrowPercentage:
							item.dataValues.lsFreeThrowPercentage,
			...
			case "standard":
				...
				db.Stats.findOne({
					...
					attributes: [
						...
						[
							Sequelize.literal(
								"(lsRebounds + lsBlocks + lsSteals + lsFouls + lsPointsPerGame) - lsTurnovers"
							),
							"fantasyValue"
						]
					],
					...
					.then((response) => {
						let player = {
							...
							minutesPerGame:
								response.dataValues.lsMinutesPerGame,
							fieldGoalPercentage:
								response.dataValues.lsFieldGoalPercentage,
							threePointPercentage:
								response.dataValues.lsThreePointPercentage,
							freeThrowPercentage:
								response.dataValues.lsFreeThrowPercentage,
					...
					.then((response) => {
						...
						response.forEach((item) => {
							results.push({
								...
								minutesPerGame:
									item.dataValues.lsMinutesPerGame,
								fieldGoalPercentage:
									item.dataValues.lsFieldGoalPercentage,
								threePointPercentage:
									item.dataValues.lsThreePointPercentage,
