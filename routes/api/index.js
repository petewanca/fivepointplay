...
module.exports = function(app) {
  ...
  app.get("/api/scrape/stats/", function(req, res) {
    ...
    //   });
      ...
      //   playersToScrape.forEach(player => {
          ...
          axios.get("https://stats.nba.com/player/201935/").then(response => {
            ...
            $("td.first").each((i, element) => {
              ...
              //   careerFga: abc,
              //   careerFgp: abc,
              //   careerThreesMade: abc,
              //   careerThreesAttempted: abc,
              //   careerThreePct: abc,
              //   careerTwosMade: abc,
              //   careerTwosAttempted: abc,
              //   careerTwosPct: abc,
              //   careerEfgp: abc,
              //   careerFt: abc,
              //   careerFta: abc,
  ...
  //   const playersToScrape = [];
  //     // object format {
  //       // playersToScrape > dataValues > teamLink
  ...
  //       db.Players.findAll({})
  //       .then(response => {
  //         numToScrape = response.length
  //         response.forEach(player => {
  //           playersToScrape.push(player)
  //         });
  //         resolve(playersToScrape)
  //       })
  //     })
  //   }
  ...
  //     // return new Promise((resolve, reject) => {
  //       playersToScrape.forEach(player=> {
  //         // console.log(player.dataValues.playerLink)
  //         axios.get(player.dataValues.playerLink).then(response => {
  //           console.log("horay")
